...
import 'package:bookthera_customer/screens/provider/book_session/payment_screen.dart';
import 'package:bookthera_customer/screens/provider/book_session/widgets/focus_selection.dart';
import 'package:bookthera_customer/screens/provider/book_session/widgets/upload_image.dart';
    ...
    return CustomLoader(
      ...
      child: Scaffold(
        ...
        body: Stack(
          ...
          children: [
            if(bookSesstionProvider.isSubLoading) LinearProgressIndicator(color: colorPrimary,minHeight: 2,),
