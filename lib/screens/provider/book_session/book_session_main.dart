...
import 'package:bookthera_provider/screens/provider/book_session/book_session_detail.dart';
import 'package:bookthera_provider/screens/provider/book_session/book_session_provider.dart';
import 'package:bookthera_provider/screens/provider/book_session/widgets/slotCell.dart';
                                ...
                                if (day.day == d.day &&
                                  ...
                                  return Container(
                                    ...
                                    child: Text(
                                      '${day.day}',
                                      style:  TextStyle(
                                          color:timeSlot.status?Colors.black:grey),
                                    ),
                                  );
                                }
                              }
