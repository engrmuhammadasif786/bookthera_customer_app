...
import 'package:bookthera_customer_1/main.dart';
import 'package:bookthera_customer_1/utils/resources/Colors.dart';
import 'package:bookthera_customer_1/utils/resources/Size.dart';
...
Widget headingText(var titleText, {int? fontSize, int maxLines = 1}) {
  return Text(titleText, style: boldTextStyle(size: fontSize ?? 22), maxLines: maxLines, overflow: TextOverflow.ellipsis);
}
